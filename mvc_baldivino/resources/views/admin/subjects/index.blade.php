    ...
    $('#addSubjectForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (errors.name) {
                    errorMessage = 'Subject name already exists. Please choose a different name.';
                } else if (errors.subject_code) {
                    errorMessage = 'Subject code already exists. Please choose a different code.';
                } else {
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        Swal.fire(
                            'Error!',
                            'Cannot delete subject. Subject cannot be delete with active student enrollments',
                            'error'
                        );
                    }
                });
